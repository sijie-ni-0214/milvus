...
TEST(SearchResultExport,
     ExportSearchResultAsArrowRecordBatch_RejectsUnpreparedRows) {
...
TEST(SearchResultExport,
     ExportSearchResultAsArrowRecordBatch_AllowsEmptyResultWithoutPrefix) {
    auto schema = std::make_shared<Schema>();
    auto pk_fid = schema->AddDebugField("pk", DataType::INT64);
    schema->set_primary_field_id(pk_fid);
    Plan plan(schema);
...
TEST(SearchResultExport,
     ExportSearchResultAsArrowRecordBatch_EmptyGroupByLayout) {
    auto schema = std::make_shared<Schema>();
    auto pk_fid = schema->AddDebugField("pk", DataType::INT64);
    schema->set_primary_field_id(pk_fid);
...
TEST(SearchResultExport,
     ExportSearchResultAsArrowRecordBatch_EmptyMultiFieldGroupByLayout) {
    auto schema = std::make_shared<Schema>();
    auto pk_fid = schema->AddDebugField("pk", DataType::INT64);
    schema->set_primary_field_id(pk_fid);
    auto group_fid_1 = schema->AddDebugField("group1", DataType::INT64);
...
TEST(
    SearchResultExport,
    ExportSearchResultAsArrowRecordBatch_AllowsSingleJsonFieldWithScalarGroupBy) {
    auto schema = std::make_shared<Schema>();
    auto pk_fid = schema->AddDebugField("pk", DataType::INT64);
    schema->set_primary_field_id(pk_fid);
...
TEST(SearchResultExport,
     ExportSearchResultAsArrowRecordBatch_RejectsMultiJsonFieldGroupBy) {
    auto schema = std::make_shared<Schema>();
    auto pk_fid = schema->AddDebugField("pk", DataType::INT64);
    schema->set_primary_field_id(pk_fid);
...
TEST(SearchResultExport, ExportSearchResultAsArrowRecordBatch_GroupByMetadata) {
    auto schema = std::make_shared<Schema>();
    auto pk_fid = schema->AddDebugField("pk", DataType::INT64);
    schema->set_primary_field_id(pk_fid);
...
TEST(SearchResultExport,
     ExportSearchResultAsArrowRecordBatch_NullableExtraFieldPreservesNulls) {
...
TEST(
    SearchResultExport,
    ExportSearchResultAsArrowRecordBatch_EmptyExtraFieldNarrowIntsUsePhysicalType) {
    using namespace milvus;
    ...
    int64_t extra_fields[] = {int8_fid.get(), int16_fid.get()};
    ArrowSchema stream_schema{};
    ArrowArray stream_array{};
    int64_t* stream_chunk_sizes = nullptr;
    int64_t stream_num_chunks = 0;
...
TEST(
    ...
    int64_t extra_fields[] = {geom_fid.get()};
    ArrowSchema stream_schema{};
    ArrowArray stream_array{};
    int64_t* stream_chunk_sizes = nullptr;
    int64_t stream_num_chunks = 0;
...
TEST(SearchResultExport,
     ExportSearchResultAsArrowRecordBatch_ExtraFieldOrderMatchesRequest) {
    using namespace milvus;
    using namespace milvus::segcore;
    ...
    int64_t extra_fields[] = {extra_high_fid.get(), extra_low_fid.get()};
    ...
    status = ExportSearchResultAsArrowRecordBatch(
...
TEST(SearchResultExport, ExportSearchResultAsArrowRecordBatch_ExtraFieldIds) {
    using namespace milvus;
    using namespace milvus::segcore;
...
TEST(SearchResultExport,
     FillFieldsOrderedAsArrowRecordBatch_EmptyRowsPreserveSchema) {
    using namespace milvus;
    ...
    int64_t field_ids[] = {int8_fid.get(), int64_fid.get(), string_fid.get()};
    ArrowSchema out_schema{};
    ArrowArray out_array{};

    auto status = FillFieldsOrderedAsArrowRecordBatch(
        c_results.data(),
        c_results.size(),
        reinterpret_cast<CSearchPlan>(plan.get()),
        field_ids,
    ...
    EXPECT_TRUE(
        (*batch_result)->schema()->field(0)->type()->Equals(arrow::int32()));
    EXPECT_TRUE(
...
TEST(SearchResultExport,
     FillFieldsOrderedAsArrowRecordBatch_PreservesFieldOrderAndMetadata) {
    using namespace milvus;
    using namespace milvus::segcore;
    ...
    std::vector<CSearchResult> c_results = {
        reinterpret_cast<CSearchResult>(&result)};
    int64_t field_ids[] = {string_fid.get(), int64_fid.get()};
...
TEST(SearchResultExport,
     FillFieldsOrderedAsArrowRecordBatch_InterleavesSegments) {
    using namespace milvus;
    using namespace milvus::segcore;
    ...
    int64_t field_ids[] = {field_fid.get()};
...
TEST(SearchResultExport,
     FillFieldsOrderedAsArrowRecordBatch_NullableValuesFollowInterleavedRows) {
    using namespace milvus;
    using namespace milvus::segcore;
    ...
    int64_t field_ids[] = {nullable_fid.get()};
...
TEST(SearchResultExport,
     FillFieldsOrderedAsArrowRecordBatch_InvalidSegmentIndexReturnsError) {
    using namespace milvus;
    using namespace milvus::segcore;
...
TEST(SearchResultExport,
     FillFieldsOrderedAsArrowRecordBatch_CancellationReturnsFollyCancel) {
    using namespace milvus;
    using namespace milvus::segcore;
