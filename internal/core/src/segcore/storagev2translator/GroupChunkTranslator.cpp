...
struct GroupChunkGetCellsTiming {
...
class GroupChunkGetCellsTimingStats {
 public:
    void
    Record(const GroupChunkGetCellsTiming& timing) {
 ...
 private:
    ...
    MaybeLog() {
        ...
        LOG_WARN(
            "segcore group chunk get cells timing stats count={} "
...
static GroupChunkGetCellsTimingStats group_chunk_get_cells_timing_stats;
...
GroupChunkTranslator::get_cells(milvus::OpContext* ctx,
    ...
    GroupChunkGetCellsTiming timing;
    ...
    group_chunk_get_cells_timing_stats.Record(timing);
