...
DECLARE_PROMETHEUS_HISTOGRAM(internal_cgo_queue_duration_seconds_reduce);
...
DECLARE_PROMETHEUS_HISTOGRAM(internal_cgo_execute_duration_seconds_reduce);
...
DECLARE_PROMETHEUS_COUNTER(internal_cgo_cancel_before_execute_total_reduce);
...
DECLARE_PROMETHEUS_COUNTER(internal_cgo_cancel_during_execute_total_reduce);
...
DECLARE_PROMETHEUS_GAUGE(internal_cgo_pool_size_reduce);
...
DECLARE_PROMETHEUS_GAUGE(internal_cgo_inflight_task_total_reduce);
...
DECLARE_PROMETHEUS_GAUGE(internal_cgo_executing_task_total_reduce);
