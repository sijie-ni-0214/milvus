...
func (suite *ServiceSuite) TestSearch_Failed() {
	...
	indexMeta := suite.node.composeIndexMeta(ctx, suite.collectionID, LoadMeta.GetSchemaVersion(), mock_segcore.GenTestIndexInfoList(suite.collectionID, schema), schema)
